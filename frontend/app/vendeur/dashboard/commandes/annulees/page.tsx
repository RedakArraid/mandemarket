...
export default function Page() {
  ...
  return (
    <div className="space-y-4">
      <SellerPageHeader title="Annulées" description="Commandes annulées." action={<></>} />
          ...
          <div className="space-y-3">
            {filtered.map((o) => (
              <div key={o.id} className="border border-gray-100 rounded-xl p-4 flex flex-col xl:flex-row xl:items-center justify-between gap-3">
                ...
                <RowActions>
                      <SellerActionButton size="sm" variant="primary" onClick={() => notifySoon("Voir le motif")}>Voir le motif</SellerActionButton>
                      <SellerActionButton size="sm" variant="ghost" href="/vendeur/dashboard/communication/support">Contacter le support</SellerActionButton>
                      <SellerActionButton size="sm" variant="outline" onClick={() => notifySoon("Remboursement")}>Remboursement</SellerActionButton>
                </RowActions>
              </div>
            ))}
          </div>

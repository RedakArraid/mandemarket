...
export default function Page() {
  ...
  return (
    <div className="space-y-4">
      <SellerPageHeader title="Expédiées" description="Commandes en cours de livraison." action={<></>} />
          ...
          <div className="space-y-3">
            {filtered.map((o) => (
              <div key={o.id} className="border border-gray-100 rounded-xl p-4 flex flex-col xl:flex-row xl:items-center justify-between gap-3">
                ...
                <RowActions>
                      <SellerActionButton size="sm" variant="primary" onClick={() => notifySoon("Suivre le colis")}>Suivre le colis</SellerActionButton>

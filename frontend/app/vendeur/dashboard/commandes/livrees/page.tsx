...
export default function Page() {
  ...
  return (
    <div className="space-y-4">
      <SellerPageHeader title="Livrées" description="Commandes livrées." action={<></>} />
            ...
            {filtered.map((o) => (
              <div key={o.id} className="border border-gray-100 rounded-xl p-4 flex flex-col xl:flex-row xl:items-center justify-between gap-3">
                ...
                <RowActions>
                      ...
                      <SellerActionButton size="sm" variant="secondary" onClick={() => notifySoon("Télécharger la facture")}>Télécharger la facture</SellerActionButton>
